...
\begin{enumerate}
	...
	\item Average regret difference - the difference between the average regrets of \textsc{TopInterval} and \textsc{IntervalChaining} across all rounds.
	...
	\item Cumulative regret difference - the difference between the cumulative regrets of \textsc{TopInterval} and \textsc{IntervalChaining} across all rounds.
	...
	\item Final regret difference - the difference between the final regrets of \textsc{TopInterval} and \textsc{IntervalChaining}.
\end{enumerate}
